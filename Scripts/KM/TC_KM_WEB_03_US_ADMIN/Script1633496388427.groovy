...
WebUI.navigateToUrl('http://km2-admin.myeyelevel.com:8090/')

WebUI.setText(findTestObject('Object Repository/KM/OR_KM_WEB_03_US_ADMIN/Page_KeyManager ver.2/input_Remember ID_id'), 'ADMIN')

WebUI.setEncryptedText(findTestObject('Object Repository/KM/OR_KM_WEB_03_US_ADMIN/Page_KeyManager ver.2/input_Remember ID_password'), 
